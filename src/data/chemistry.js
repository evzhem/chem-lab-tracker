...
export const ACIDS = [
  ...
  { acid: 'HClO₄', name: 'Хлорная', residue: 'ClO₄⁻', residueName: 'перхлорат' },
  { acid: 'HClO₃', name: 'Хлорноватая', residue: 'ClO₃⁻', residueName: 'хлорат' },
  { acid: 'HClO', name: 'Хлорноватистая', residue: 'ClO⁻', residueName: 'гипохлорит' },
  { acid: 'HCN', name: 'Синильная', residue: 'CN⁻', residueName: 'цианид' },
  { acid: 'CH₃COOH', name: 'Уксусная', residue: 'CH₃COO⁻', residueName: 'ацетат' },
  { acid: 'HCOOH', name: 'Муравьиная', residue: 'HCOO⁻', residueName: 'формиат' },
  { acid: 'H₂C₂O₄', name: 'Щавелевая', residue: 'C₂O₄²⁻', residueName: 'оксалат' },
]
...
// legacy re-exports for older Reference page if needed
